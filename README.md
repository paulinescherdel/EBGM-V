This code repository is associated with the publication "Development, internal and external evaluation of an artificial intelligence algorithm for child growth monitoring in primary care". 
